...
### Convert into structured Markdown (.md)
...
### CLI Tool (e.g., python app.py input.pdf output.md)

### 2

### OR Minimal Web App (upload + download)
...
### Detailed README (setup, usage, explanation, limitations)
